...
var SubjectConstructorStrategy = exports.SubjectConstructorStrategy = /*#__PURE__*/function () {
  function SubjectConstructorStrategy(params) {
    _classCallCheck(this, SubjectConstructorStrategy);
  ...
  return _createClass(SubjectConstructorStrategy, [{
    key: "exec",
    value: function exec(term) {
      return _construct(this.fn(), _toConsumableArray(term.params));
    }
  }, {
    key: "fn",
    value: function fn() {
